...
<body><div class="buyer">
		<ul><li><a  href="http://localhost:8080/TheNextDoorHub/search.jsp">Search</a>
...
try{
    ...
    PreparedStatement ps= con.prepareStatement("select * from item where status =? and seller !=? and buyer !=?");
...
%>
		...
		<input type="hidden" value="<%=rst.getString("category")%>" name="category">
	        ...
	        count++;
		     ...
		     %>
		       <p><font size=10>No Live Auctions!</font></p>
		   	<%
