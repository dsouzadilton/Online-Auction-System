...
%>
	        ...
	        <form method="post" action="AdminNotify">
		<table>
			<tr>
				<td><input class="btn" type="submit"  value="Notify <%=rst.getString("buyer")%>" name="notify"></td>
			</tr>
		</table>
	...
	</form></div><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
	        <% 
	        count++;
	    }if(count==0){
		     %>
